...
public class AllIssueController {
    ...
    public String viewAllIssues(@RequestParam(value = "startDate", required = false) @DateTimeFormat(pattern = "yyyy-MM-dd") Date startDate,
    ...
    private List<Issue> createMockIssues() {
        ...
        issues.add(new Issue(1, "Issue 1", "Description 1", "Resolution 1", 101, "Category 1", 201, "New", new Date(), null, 301, "Reporter 1", 401, null, 0, false));
