...
public class StatisticsController {
    ...
    static {
        ...
        issueDatabase.put(2, new Issue(2, "Issue 2", "Description for issue 2", "Resolution 2", 102, "Category 1", 202, "Resolved", new Date(System.currentTimeMillis() - 86400000 * 14), new Date(System.currentTimeMillis() - 86400000 * 7), 302, "Reporter 2", 402, "Assignee 2", 0, false));
        issueDatabase.put(3, new Issue(3, "Issue 3", "Description for issue 3", "Resolution 3", 103, "Category 3", 203, "In Progress", new Date(System.currentTimeMillis() - 86400000 * 3), null, 303, "Reporter 3", 403, null, 0, false));
        issueDatabase.put(4, new Issue(4, "Issue 4", "Description for issue 4", "Resolution 4", 104, "Category 4", 204, "Waiting on Third Party", new Date(System.currentTimeMillis() - 86400000 * 5), null, 304, "Reporter 4", 404, null, 0, false));
        issueDatabase.put(5, new Issue(5, "Issue 5", "Description for issue 5", "Resolution 5", 105, "Category 5", 205, "Waiting on Reporter", new Date(System.currentTimeMillis() - 86400000 * 10), null, 305, "Reporter 5", 405, null, 0, false));
    }
